...
void configurar_ventana_prog_riego(void)
{
	...
	char duracion_valvula = '0';//repositorio->getDuracionValv(repositorio->getIdProgramaSeleccionado(), 1);
	...
	duracion_valvula = '0';//repositorio->getDuracionValv(repositorio->getIdProgramaSeleccionado(), 2);
	sprintf(campo_valv, "%d\0", duracion_valvula);	
	...
	duracion_valvula = '0';//repositorio->getDuracionValv(repositorio->getIdProgramaSeleccionado(), 3);
	sprintf(campo_valv, "%d\0", duracion_valvula);	
	...
	duracion_valvula = '0';//repositorio->getDuracionValv(repositorio->getIdProgramaSeleccionado(), 4);
	sprintf(campo_valv, "%d\0", duracion_valvula);	
