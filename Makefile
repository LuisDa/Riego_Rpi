...
all:	control_riego_bg	control_riego_rpi	prueba_comandos_shm	interfaz_conf_riego

#Cleanup
.PHONY: clean

clean:
	rm -f *.o *~ core *~ control_riego_bg control_riego_rpi interfaz_conf_riego prueba_comandos_shm
